                            ...
                            onTap: () {
                              ...
                              if (screen.isPhone) {
                                if (controller.controllerHome.scaffoldKey
                                  ...
                                  controller
                                      .controllerHome.scaffoldKey.currentState!
                                      .closeDrawer();
                                }
                              }
                            },
            ...
            child: InkWell(
              ...
              onTap: () {
                ...
                if (controller.controllerHome.titleSelected.value == "Home") {
                  locator<NavigationService>().navigateTo(AppRoutes.HOMEROUTE);
                } else {
                  locator<NavigationService>().navigateTo(AppRoutes.DETAILROUTE,
                      args: {"data": data["title"]});
                }

                if (screen.isPhone) {
                  if (controller
                      .controllerHome.scaffoldKey.currentState!.isDrawerOpen) {
